# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/showdoc.ipynb.

# %% ../nbs/api/showdoc.ipynb 2
...
# %% ../nbs/api/showdoc.ipynb 52
def doc(elt):
    "Show `show_doc` info along with link to docs"
    BasicHtmlRenderer(elt).doc()

# %% ../nbs/api/showdoc.ipynb 58
def showdoc_nm(tree):
    "Get the fully qualified name for showdoc."
    return ifnone(patch_name(tree), tree.name)

# %% ../nbs/api/showdoc.ipynb 62
def colab_link(path):
